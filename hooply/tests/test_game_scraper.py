...
def test_game_scraper(
    ...
    patched_extract_game: MagicMock,
    patched_extract_four_factors: MagicMock,
    patched_extract_player_factors: MagicMock,
):
    ...
    test_team_four_factors = {
        "GSW": ["92.1", ".516", "111.8"],
        "BOS": ["92.1", ".494", "97.7"],
    }
    test_game_info = [
        ["Boston Celtics", "90", "2-4"],
        ["Golden State Warriors", "103", "4-2"],
    ]
    test_players = {
        "GSW": [
            "Andrew Wiggins",
